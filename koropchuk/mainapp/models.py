...
class Article(models.Model):
    ...
    content = models.TextField(blank=True, verbose_name='Текст допису')
    photo = models.ImageField(upload_to="photos/%Y/%m/%d", verbose_name='Зображення 16:9/800:450px/WebP')
